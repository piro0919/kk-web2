...
type SitePageContextNextNode = {
  readonly frontmatter: Maybe<SitePageContextNextNodeFrontmatter>;
};

type SitePageContextNextNodeFrontmatter = {
...
type SitePageContextPrev = {
  readonly node: Maybe<SitePageContextPrevNode>;
};

type SitePageContextPrevNode = {
  readonly frontmatter: Maybe<SitePageContextPrevNodeFrontmatter>;
};

type SitePageContextPrevNodeFrontmatter = {
  readonly date: Maybe<Scalars['Date']>;
  readonly slug: Maybe<Scalars['String']>;
  readonly title: Maybe<Scalars['String']>;
};
...
type SitePageContextNextFilterInput = {
  readonly node: Maybe<SitePageContextNextNodeFilterInput>;
};

type SitePageContextNextNodeFilterInput = {
  readonly frontmatter: Maybe<SitePageContextNextNodeFrontmatterFilterInput>;
};

type SitePageContextNextNodeFrontmatterFilterInput = {
  readonly date: Maybe<DateQueryOperatorInput>;
  readonly slug: Maybe<StringQueryOperatorInput>;
  readonly title: Maybe<StringQueryOperatorInput>;
};
...
type SitePageContextPrevFilterInput = {
  readonly node: Maybe<SitePageContextPrevNodeFilterInput>;
};

type SitePageContextPrevNodeFilterInput = {
  readonly frontmatter: Maybe<SitePageContextPrevNodeFrontmatterFilterInput>;
};

type SitePageContextPrevNodeFrontmatterFilterInput = {
  readonly date: Maybe<DateQueryOperatorInput>;
  readonly slug: Maybe<StringQueryOperatorInput>;
  readonly title: Maybe<StringQueryOperatorInput>;
};
...
type SitePageFieldsEnum =
  ...
  | 'pluginCreator.pluginOptions.sassOptions.includePaths'
...
type SitePluginFieldsEnum =
  ...
  | 'name'
  | 'version'
  | 'pluginOptions.sassOptions.includePaths'
...
type BlogIndexQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'slug' | 'title'>>, readonly internal: Pick<Internal, 'content'> } }> } };
